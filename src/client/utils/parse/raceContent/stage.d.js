 ...
 * @property {string} year - The year of the stage.
 * @property {string} date - The date of the stage.
 * @property {string} stage - The stage number.
 ...
 * @property {string} distance - The distance of the stage in kilometers.
 * @property {string} verticalMeters - The vertical meters of the stage.
 ...
 * @property {Date} date - The date of the stage.
